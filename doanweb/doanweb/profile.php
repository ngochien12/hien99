		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><b><?= $_SESSION["current_user"]->f_Username ?></b> <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="header("Location: index.php")">Thông tin cá nhân</a></li>
